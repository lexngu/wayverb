...
template <>
struct get_shader_iv_trait<juce::gl::GL_SHADER_TYPE> final {
    using return_type = GLint;
};
template <>
struct get_shader_iv_trait<juce::gl::GL_DELETE_STATUS> final {
    using return_type = bool;
};
template <>
struct get_shader_iv_trait<juce::gl::GL_COMPILE_STATUS> final {
    static constexpr const char* description{"compile status"};
    using return_type = bool;
};
template <>
struct get_shader_iv_trait<juce::gl::GL_INFO_LOG_LENGTH> final {
    using return_type = GLint;
};
template <>
struct get_shader_iv_trait<juce::gl::GL_SHADER_SOURCE_LENGTH> final {
    using return_type = GLint;
};
...
template <>
struct get_program_iv_trait<juce::gl::GL_DELETE_STATUS> final {
    using return_type = bool;
};
template <>
struct get_program_iv_trait<juce::gl::GL_LINK_STATUS> final {
    static constexpr const char* description{"link status"};
    using return_type = bool;
};
template <>
struct get_program_iv_trait<juce::gl::GL_VALIDATE_STATUS> final {
    static constexpr const char* description{"validate status"};
    using return_type = bool;
};
template <>
struct get_program_iv_trait<juce::gl::GL_INFO_LOG_LENGTH> final {
    using return_type = GLint;
};
template <>
struct get_program_iv_trait<juce::gl::GL_ATTACHED_SHADERS> final {
    using return_type = GLint;
};
template <>
struct get_program_iv_trait<juce::gl::GL_ACTIVE_ATTRIBUTES> final {
    using return_type = GLint;
};
template <>
struct get_program_iv_trait<juce::gl::GL_ACTIVE_ATTRIBUTE_MAX_LENGTH> final {
    using return_type = GLint;
};
template <>
struct get_program_iv_trait<juce::gl::GL_ACTIVE_UNIFORMS> final {
    using return_type = GLint;
};
template <>
struct get_program_iv_trait<juce::gl::GL_ACTIVE_UNIFORM_MAX_LENGTH> final {
    using return_type = GLint;
};
...
inline std::string get_shader_info_log(GLuint handle) {
    return get_info_log(juce::gl::glGetShaderInfoLog, handle);
}

inline std::string get_program_info_log(GLuint handle) {
    return get_info_log(juce::gl::glGetProgramInfoLog, handle);
}

template <GLenum flag>
inline detail::get_shader_iv_trait_t<flag> get_shader_iv(GLuint handle) {
    GLint ret;
    juce::gl::glGetShaderiv(handle, flag, &ret);
...
inline detail::get_program_iv_trait_t<flag> get_program_iv(GLuint handle) {
    GLint ret;
    juce::gl::glGetProgramiv(handle, flag, &ret);
