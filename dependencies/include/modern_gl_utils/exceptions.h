...
constexpr const char* to_string(GLenum e) {
    switch (e) {
        case juce::gl::GL_NO_ERROR:
            return detail::gl_error_type_description_v<juce::gl::GL_NO_ERROR>;
        case juce::gl::GL_INVALID_ENUM:
            return detail::gl_error_type_description_v<juce::gl::GL_INVALID_ENUM>;
        case juce::gl::GL_INVALID_VALUE:
            return detail::gl_error_type_description_v<juce::gl::GL_INVALID_VALUE>;
        case juce::gl::GL_INVALID_OPERATION:
            return detail::gl_error_type_description_v<juce::gl::GL_INVALID_OPERATION>;
        case juce::gl::GL_INVALID_FRAMEBUFFER_OPERATION:
            return detail::gl_error_type_description_v<
            juce::gl::GL_INVALID_FRAMEBUFFER_OPERATION>;
        case juce::gl::GL_OUT_OF_MEMORY:
            return detail::gl_error_type_description_v<juce::gl::GL_OUT_OF_MEMORY>;
        default:
